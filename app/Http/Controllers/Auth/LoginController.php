...
// $user->password = Hash::make('yourpassword'); // Replace with the actual password
// $user->save();
        $request->validate([
        ...
        try {
            ...
            if (Auth::attempt(['email'=>$email,'password'=>$password])) {
                ...
                // dd(Auth::attempt(['email'=>$email,'password'=>$password]),['email'=>$email,'password'=>$password],"Login failed");
